...
yolo_model = YOLO("yolov8n.pt")  # nano model (fastest for real-time)

# 🔹 Load your trained EfficientNetV2 classifier (TorchScript)
efficientnet_model = torch.jit.load("efficientnetv2_trashnext_rpi.pt", map_location="cpu")
...
# 🔹 Image transformation for EfficientNetV2 (300x300 input)
...
print("📷 Starting hybrid YOLO + EfficientNetV2... Press 'q' to quit.")
...
while True:
    ...
    for i, box in enumerate(detections):
        ...
        # Convert to PIL & preprocess for EfficientNetV2
    ...
    # Show video
    cv2.imshow("VisionBin YOLO + EfficientNetV2", frame)
